...
function M(p1, p2) {
  var tl = new TimelineMax({ repeat: -1 })
    ...
    .to(
      p1 + " .F3",
      0.25,
      { rotation: -35, repeat: 1, yoyo: true, scaleX: 0.925 },
      "l2"
    )
    .to(p2, 0.5, { rotation: 25, ease: E0, yoyo: true, repeat: 1 }, "l1")
    .to(
      p2 + " .H1",
      0.5,
      { rotation: 15, ease: E0, yoyo: true, repeat: 1 },
      "l1"
    )
    .to(
      p2 + " .H2",
      0.5,
      { rotation: 0, ease: E0, yoyo: true, repeat: 1 },
      "l1"
    );
  return tl;
}
var MTl = new TimelineLite()
  .add(M("#FF", "#HB"))
  .add(M("#FB", "#HF"), 0.5)
  .to(B, 0.25, { y: "+=" + -20, repeat: -1, yoyo: true, ease: E0 }, 0)
